...
\begin{description}
 \item[Połączenie obserwacji i stanów chorobowych] - każde połączenie objawu ze
 stanem chorobowym opisane jest współczynnikiem stopnia zaufania, którego 
 wartość dodatnia sugeruje wysoką korelację objawu i choroby, a wartość ujemna 
 niską lub brak korelacji.
 \item[Połączenie stanów chorobowych z klasami chorób] - połączenie wiąże
 ...
 połączony z niedokładnie określoną klasą.
 \framebreak
 \item[Połączenie klasy choroby z leczeniem] - każda klasa ma przypisany do
 niej odpowiedni sposób lecznia.
 \item[Połączenie objawów z leczeniem] - choć to połączenie zaburza spójność
